...
# === Construction du modèle ResNet18 ===
...
X_scaled_2d = scaler.fit_transform(X.reshape(len(X), -1))
X_reshaped = X_scaled_2d.reshape((-1, 13, 16, 1))
...
# === Entraînement
model = build_resnet18_model((13, 16, 1), 4)
...
model.save("resnet18_model_singlefile.keras")
model_size_mb = os.path.getsize("resnet18_model_singlefile.keras") / (1024 * 1024)
